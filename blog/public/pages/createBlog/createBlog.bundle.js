...
/***/ function(module, exports, __webpack_require__) {
	...
	function inserElementInCursor(tagName) {
		var selection = window.getSelection();
		var element = document.createElement(tagName);
		element.innerHTML = "<br/>";
		var sRange = selection.getRangeAt(0);
		sRange.collapse();
		sRange.insertNode(element);
	...
	function isFirstLevelNode() {
		...
		if (range.commonAncestorContainer == $(".blogContainer")[0]) return range.commonAncestorContainer;
		if (range.commonAncestorContainer.parentNode == $(".blogContainer")[0]) return range.commonAncestorContainer.parentNode;
	...
	tabUtil.register("img", dealImg);
	//code标签
	function dealCode(tag, clazz, param) {
	...
	$(function () {
		...
		$blogContainer.on("focus", function (e) {
			if ($(this).html() == "") {
				$(this).html("<p><br/></p>");
