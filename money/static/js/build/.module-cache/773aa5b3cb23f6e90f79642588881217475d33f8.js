	...
	var Container = React.createClass({displayName: "Container",
		...
		getPreData:function(){
			...
			$.get(root_url + '/moneyDetail').done(this.cbGetPreData.bind(this,"cost"));
	...
	var MonthHistory = React.createClass({displayName: "MonthHistory",
		...
		componentWillMount:function(){
			var that = this;
			$.get("/monthHistory").done(function(data){
				if(data.code == 200){
		...
		render:function(){
			var arr = [];
			for(var date in this.state.monthHistory){
				var obj = this.state.monthHistory[date];
				arr.push(
					React.createElement("li", {className: "list-group-item"}, 
						React.createElement("div", {className: "row"}, 
							React.createElement("div", {className: "col-xs-4"}, React.createElement("span", {className: "label label-info"}, date)), 
							React.createElement("div", {className: "col-xs-4"}, React.createElement("span", {className: "badge"}, "本月收入：", obj.monthIn)), 
							React.createElement("div", {className: "col-xs-4"}, React.createElement("span", {className: "badge"}, "本月支出：", obj.monthOut))
						)
					)
