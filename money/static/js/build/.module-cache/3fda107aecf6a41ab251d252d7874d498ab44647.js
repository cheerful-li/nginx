	...
	var Container = React.createClass({displayName: "Container",
		...
		clickToMonitor: function(){
			
			setTimeout(function(){
				window.mychart.reflow();
			},0)
		},
		render: function(){
			return (
				...
				React.createElement("ul", {className: "nav nav-tabs", id: "nav"}, 
							React.createElement("li", null, 
								React.createElement("a", {href: "#monitorContainer", onClick: this.clickToMonitor, "data-toggle": "pill"}, "图表")
							), 
							React.createElement("li", null, 
				...
				React.createElement("div", {style: {padding: '0px 1px'}}, 
					React.createElement("div", null, 
						React.createElement("div", {className: "tab-content"}, 
							...
							React.createElement("div", {className: "tab-pane fade ", style: {width:"100%",height:"100%"}, id: "monitorContainer"}, 
		...
		render:function(){
			...
			return (	
						React.createElement("div", null, 
							...
							React.createElement("div", {style: {width:'99%',height:'100%',paddingBottom:48,paddingTop:50}, className: "center-block", id: "monitorParent", ref: "monitorParent"}, 
								loading
							)
						)
